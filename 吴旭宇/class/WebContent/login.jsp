...
<html>
	...
	<body>
		<div class="container animated bounceInLeft">
			...
			<div class="col-sm-5">
				<form action="stu" method="post" class="form-reg">
					<!-- 使用隐藏域来区分该表单是登录还是注册 -->
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" name="id" value="${id }" placeholder="输入学号" class="form-control" pattern="^1[1234]\d{4}$" required/>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
					...
					<div class="form-group text-right">
						<span>没有账号？<a href="reg.jsp">注册账号</a></span>
					</div>
					<div class="form-group text-right">
